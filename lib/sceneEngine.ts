...
import type { SceneTriggerContext } from "@/types/backend";

export function buildScenePushMessages(context: SceneTriggerContext): ChatMessage[] {
    ...
    messages.push(
      ...
      },
      {
        ...
        rows: [
          ...
          { label: "提醒对象", value: context.delegationMode === "family_proxy" ? "已同步给代办亲属" : "当前本人处理" }
        ]
      }
    );
  }
